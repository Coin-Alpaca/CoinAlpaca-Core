...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/CoinAlpaca-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/CoinAlpaca-cli.cpp \
           src/CoinAlpaca-tx.cpp \
           src/CoinAlpaca.cpp \
           src/db.cpp \
           ...
           src/qt/CoinAlpaca.cpp \
           src/qt/CoinAlpacastrings.cpp \
...
RESOURCES += src/qt/CoinAlpaca.qrc src/qt/CoinAlpaca_locale.qrc

TRANSLATIONS += src/qt/locale/CoinAlpaca_bg.ts \
                src/qt/locale/CoinAlpaca_de.ts \
                src/qt/locale/CoinAlpaca_en.ts \
                src/qt/locale/CoinAlpaca_es.ts \
                src/qt/locale/CoinAlpaca_fi.ts \
                src/qt/locale/CoinAlpaca_fr.ts \
                src/qt/locale/CoinAlpaca_it.ts \
                src/qt/locale/CoinAlpaca_ja.ts \
                src/qt/locale/CoinAlpaca_pl.ts \
                src/qt/locale/CoinAlpaca_pt.ts \
                src/qt/locale/CoinAlpaca_ru.ts \
                src/qt/locale/CoinAlpaca_sk.ts \
                src/qt/locale/CoinAlpaca_sv.ts \
                src/qt/locale/CoinAlpaca_vi.ts \
                src/qt/locale/CoinAlpaca_zh_CN.ts \
                src/qt/locale/CoinAlpaca_zh_TW.ts
