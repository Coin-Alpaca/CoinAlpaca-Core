Contributing to CoinAlpaca Core
==================================

The CoinAlpaca Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CoinAlpaca Core project, and is not to be
confused with overall CoinAlpaca Network Protocol consensus changes.

Whether a pull request is merged into CoinAlpaca Core rests with the project merge
...
Patches that change CoinAlpaca consensus rules are considerably more involved than
...
Where a patch set proposes to change the CoinAlpaca consensus, it must have been
...
The project leader is the release manager for each CoinAlpaca Core release.
