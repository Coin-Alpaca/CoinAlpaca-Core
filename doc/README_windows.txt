...
Intro
-----
CoinAlpaca (CALP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CoinAlpaca utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run CoinAlpaca-qt.exe.

CoinAlpaca Core is the original CoinAlpaca client and it builds the backbone of the network.
However, it downloads and stores the entire history of CoinAlpaca transactions;
