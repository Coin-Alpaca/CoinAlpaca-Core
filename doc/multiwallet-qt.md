...
In order to support loading of multiple wallets in CoinAlpaca-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is CoinAlpaca.cpp.
...
Changes to CoinAlpaca.cpp
----------------------
CoinAlpaca.cpp is the entry point into CoinAlpaca-qt, and as such, will require some minor modifications to provide hooks for
