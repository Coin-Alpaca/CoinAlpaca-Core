...
#   c) node1 mines 32 blocks, so now node 0 has 500000CALP, node 1 has 4250CALP, node2 has none.
#   d) node0 sends 601 CALP to node2, in two transactions (301 CALP, then 300 CALP).
