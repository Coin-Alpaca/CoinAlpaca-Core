...
// Copyright (c) 2018 The CoinAlpaca developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CoinAlpaca Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CALP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CoinAlpaca: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CoinAlpaca Core"), this);
    aboutAction->setStatusTip(tr("Show information about CoinAlpaca Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CoinAlpaca"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CALP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CALP addresses"));
    ...
    openAction->setStatusTip(tr("Open a CoinAlpaca: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CoinAlpaca Core help message to get a list with possible CoinAlpaca command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CoinAlpaca Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CoinAlpaca network", "", count));
}
...
{
    QString strTitle = tr("CoinAlpaca Core"); // default title
