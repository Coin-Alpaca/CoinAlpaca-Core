...
/** Utility functions used by the CoinAlpaca Qt UI.
 */
namespace GUIUtil
{
...
// Render CALP addresses in monospace font
...
// Parse "CoinAlpaca:" URI into recipient object, return true on successful parsing
