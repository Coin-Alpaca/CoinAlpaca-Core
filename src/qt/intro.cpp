...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CoinAlpaca Core"),
     ...
     * override -datadir in the CoinAlpaca.conf file in the default data directory
     * (to be consistent with CoinAlpacad behavior)
     */
    if (dataDir != getDefaultDataDirectory())
