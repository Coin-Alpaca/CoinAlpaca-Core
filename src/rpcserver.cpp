...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CoinAlpaca server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CoinAlpaca server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CoinAlpaca features */
        {"CoinAlpaca", "masternode", &masternode, true, true, false},
        {"CoinAlpaca", "listmasternodes", &listmasternodes, true, true, false},
        {"CoinAlpaca", "getmasternodecount", &getmasternodecount, true, true, false},
        {"CoinAlpaca", "masternodeconnect", &masternodeconnect, true, true, false},
        {"CoinAlpaca", "masternodecurrent", &masternodecurrent, true, true, false},
        {"CoinAlpaca", "masternodedebug", &masternodedebug, true, true, false},
        {"CoinAlpaca", "startmasternode", &startmasternode, true, true, false},
        {"CoinAlpaca", "createmasternodekey", &createmasternodekey, true, true, false},
        {"CoinAlpaca", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"CoinAlpaca", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"CoinAlpaca", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"CoinAlpaca", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"CoinAlpaca", "getmasternodescores", &getmasternodescores, true, true, false},
        {"CoinAlpaca", "mnbudget", &mnbudget, true, true, false},
        {"CoinAlpaca", "preparebudget", &preparebudget, true, true, false},
        {"CoinAlpaca", "submitbudget", &submitbudget, true, true, false},
        {"CoinAlpaca", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"CoinAlpaca", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"CoinAlpaca", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"CoinAlpaca", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"CoinAlpaca", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"CoinAlpaca", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"CoinAlpaca", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"CoinAlpaca", "checkbudgets", &checkbudgets, true, true, false},
        {"CoinAlpaca", "mnsync", &mnsync, true, true, false},
        {"CoinAlpaca", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> CoinAlpaca-cli " + methodname + " " + args + "\n";
}
