...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CoinAlpaca Core CoinAlpaca-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CoinAlpaca-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CoinAlpaca transaction") + "\n" +
                               "  CoinAlpaca-tx [options] -create [commands]   " + _("Create hex-encoded CoinAlpaca transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CoinAlpaca transaction
